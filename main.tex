...
* lastlogindex and lastlogterm handling
TODO

\textbf{Candidate handling}
* term higher => step down
* what happens when not enough votes are received in time? => election timer
* retry message sending with candidate timer
* enough votes => switch to leader
...
prevLogIndex &  TODO \\ \hline
prevLogTerm &  TODO \\ \hline
