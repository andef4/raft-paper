...
The followers receive the heartbeat message and update their own commitIndex to the index from the master, sent in the leaderCommit field of the AppendEntry heartbeat.
}
...
\begin{itemize}
    ...
    \item Multithreaded progamming with sockets and timers
