...
Node S1 and S2 time out at nearly the same time and send out RequestVote request. The picture shows the RequestVotre responses: S1 and S2 reject the vote for ea
}
...
TODO update commit index in next appendentry heartbeat
}

\raftscopedata{scenarios/data_write/34.pdf_tex}{
TODO Tnodes update commit index
}
